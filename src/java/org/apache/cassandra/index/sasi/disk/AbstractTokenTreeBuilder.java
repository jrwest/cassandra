...
public abstract class AbstractTokenTreeBuilder implements TokenTreeBuilder
{
    ...
    protected void maybeBulkLoad()
    {
        if (root == null)
            bulkLoad();
    }

    protected abstract void bulkLoad();
    ...
    protected class InteriorNode extends Node
    {
        ...
        protected int position = 0; // TODO (jwest): can get rid of this and use array size
