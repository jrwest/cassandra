...
public class RangeUnionIteratorTest
{
    ...
    public void testBuilder()
    {
        ...
        RangeIterator<Long, IndexEntry> tokens = RangeUnionIterator.build(new ArrayList<RangeIterator<Long, IndexEntry>>()
        {{
    ...
    {
        RangeUnionIterator.Builder<Long, IndexEntry> builderA = RangeUnionIterator.builder();

        builderA.add(new LongIterator(new long[] { 1L, 3L, 5L }));
        builderA.add(new LongIterator(new long[] { 8L, 10L, 12L }));

        RangeUnionIterator.Builder<Long, IndexEntry> builderB = RangeUnionIterator.builder();

        builderB.add(new LongIterator(new long[] { 7L, 9L, 11L }));
        builderB.add(new LongIterator(new long[] { 2L, 4L, 6L }));

        RangeIterator<Long, IndexEntry> union = RangeUnionIterator.build(Arrays.asList(builderA.build(), builderB.build()));
