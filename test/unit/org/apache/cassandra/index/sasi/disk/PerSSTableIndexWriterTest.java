...
public class PerSSTableIndexWriterTest extends SchemaLoader
{
    ...
    public void testPartialIndexWrites() throws Exception
    {
        ...
        OnDiskIndex index = new OnDiskIndex(new File(indexFile), new ClusteringComparator(), Int32Type.instance, keyPosition -> {
        ...
        for (OnDiskIndex.DataTerm term : index)
        {
            ...
            {
                for (IndexEntry.EntryData entry : tokens.next())
